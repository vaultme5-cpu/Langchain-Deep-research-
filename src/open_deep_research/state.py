...
class AgentState(TypedDict):
    ...
    erc_previous_fingerprint: str
    erc_no_progress_count: int
    erc_last_evidence_count: int
    erc_last_completed_count: int
    erc_open_questions: Annotated[list, override_reducer]
    erc_unresolved_contradictions: Annotated[list, override_reducer]
    erc_source_family_coverage: Annotated[dict, merge_dicts]
