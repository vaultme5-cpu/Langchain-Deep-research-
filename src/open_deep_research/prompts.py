...
compress_research_simple_human_message = "Compress and structure the research findings into atomic evidence nodes."

compress_research_system_prompt = "You are a research compression specialist. Transform raw research into structured evidence nodes."

research_system_prompt = "You are a research execution agent. Follow the research plan and gather verifiable evidence."
