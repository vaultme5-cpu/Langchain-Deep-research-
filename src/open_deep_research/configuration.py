"""Configuration management for the Omega Supremacy Engine."""
import os
...
class Configuration(BaseModel):
    ...
    max_concurrent_research_units: int = Field(default=3) # Optimized for Groq Free-Tier RPM
