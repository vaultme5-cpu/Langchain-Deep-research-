...
class Configuration(BaseModel):
    ...
    summarization_model: str = Field(default="google_genai:gemini-2.0-flash")
    ...
    research_model: str = Field(default="google_genai:gemini-2.0-flash")
    research_model_max_tokens: int = Field(default=10000)
    
    # Fast model for compressing evidence graphs
    compression_model: str = Field(default="google_genai:gemini-2.0-flash")
    compression_model_max_tokens: int = Field(default=8192)
    
    # Heavy logic model for final report synthesis
    final_report_model: str = Field(default="google_genai:gemini-2.0-flash")
