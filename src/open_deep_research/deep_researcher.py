...
# configurable_model will be created per invocation
...
researcher_builder = StateGraph(AsyncStateGraph(ResearcherState, output_schema=ResearcherOutputState, config_schema=Configuration)
