...
def _chunk_messages_for_compression(messages, target_tokens=1200, max_messages=3, max_segment_chars=450):
...
async def _compress_message_chunk(sm, chunk_messages, configurable, depth=0, target_tokens=1200):
    ...
    if prompt_tokens > target_tokens and depth < 5 and len(chunk_messages) == 1:
        expanded = _expand_messages_for_compression(chunk_messages, max_segment_chars=250)
